...
<header class="page-header">
    <div class="d-flex align-items-center">
        ...
        {!! Form::open(['route' =>['admin.case-study.index'],'class'=>'d-flex align-items-centers','method'=>'GET']) !!}
        ...
        {!! Form::close() !!} 
         <div class="m-l-10">
            <a href="{{ route('admin.case-study.create') }}" class="btn btn-primary "> Add Case-study</a>
        </div> 
    </div>
</header>
