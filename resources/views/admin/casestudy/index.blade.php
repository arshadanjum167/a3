...
<div class="content">
    @include('admin.casestudy._header')
                                        ...
                                        <td class="table-field-actions text-center">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-icon-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{ route('admin.case-study.edit',['id'=>$value->id]) }}"><i class="zmdi zmdi-edit zmdi-hc-fw text-secondary"></i> Edit</a>
                                                    {{ Form::open(array('route' =>['admin.case-study.destroy',$value->id])) }}
...
@section('custom_scripts')
  ...
  @include('global.active_inactive',['route'=>'admin.case-study.status_change']) 
@endsection
