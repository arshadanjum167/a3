...
@include('admin.user._playerheader')
                      ...
                      @endif
  					    ...
  					    <td class="table-field-actions text-center">
      						<div class="btn-group">
      						    ...
      						    <div class="dropdown-menu dropdown-icon-menu dropdown-menu-right">
          							<a class="dropdown-item" href="{{ route('admin.user.playershow',['id'=>$data->id]) }}"><i class="zmdi zmdi-eye zmdi-hc-fw text-secondary"></i> View</a>
