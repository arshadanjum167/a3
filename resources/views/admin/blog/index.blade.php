...
$arr_read_count = ['search' => $search ,'read_count'=>$read_count,'sort'=>$sort];
@endphp
                            ...
                            <table class="table m-0" id="example1">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sortable">Route Name</th>
                                        <th class="sortable {{ $sort_val }}"><a href="{{ route('admin.blog.index',$arr_read_count)}}">Read Count</a></th>
                                        ...
                                        <td class="table-field-actions text-center">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-icon-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="{{ route('admin.blog.edit',['id'=>$value->id]) }}"><i class="zmdi zmdi-edit zmdi-hc-fw text-secondary"></i> Edit</a>
                                                    {{ Form::open(array('route' =>['admin.blog.destroy',$value->id])) }}
...
@section('custom_scripts')
  ...
  @include('global.active_inactive',['route'=>'admin.blog.status_change']) 
@endsection
