    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <span class="display--5 mb-4">Our team is the foundation of our success. Comprised of skilled architects, designers, and construction professionals, each member brings unique expertise and a passion for creating exceptional spaces. We work collaboratively to deliver innovative solutions, ensuring every project reflects our commitment to quality, creativity, and client satisfaction. Together, we shape spaces that inspire and endure.</span>
            </div>
            <div class="row g-0 team-items">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item position-relative">
                        ...
                        <div class="bg-light text-center p-4">
                            <h3 class="mt-2">Er. Akib Memon</h3>
                            <!-- <span class="text-primary">Designation</span> -->
                        </div>
                    </div>
                </div>
