...
@php 
$projects = CommonFunction::getGetAllProjects();
@endphp
  <!-- Carousel Start -->
                  ...
                  <div class="container">
                      <div class="row justify-content-start">
                            <div class=" text-reveal-container">
                                <div class="text-reveal-ball"></div>
                                <h1 class="display-1 text-white animated1 slideInDown text-reveal-string ">Innovative Architecture, Inspired Interiors</h1>
                            </div>
              ...
              <div class="owl-carousel-inner">
                  <div class="container">
                      <div class="row justify-content-start">
                            <div class=" text-reveal-container">
                                <div class="text-reveal-ball"></div>
                                <h1  class="display-1 text-white animated1 slideInDown text-reveal-string ">Shaping Spaces, Building Futures & more</h1>
                            </div>
                          <div class="col-10 col-lg-8">
              ...
              <div class="owl-carousel-inner">
                  <div class="container">
                      <div class="row justify-content-start">
                            <div class=" text-reveal-container">
                                <div class="text-reveal-ball"></div>
                                <h1  class="display-1 text-white animated1 slideInDown text-reveal-string ">Creating Timeless Designs for Every Space</h1>
                            </div>
                          <div class="col-10 col-lg-8">
  ...
  <div class="container-xxl project py-5">
      <div class="container">
          <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
              ...
              <h1 class="display-5 mb-4 water-effect">Visit Our Latest Projects And Our Innovative Works</h1>
          </div>
                  ...
                  <div class="tab-content w-100">
                      <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            if(isset($projects) && $projects){
                                $imageChunks = array_chunk($projects, 2);
                                        ...
                                        <div class="col-md-6" style="min-height: 350px;">
                                            <a href="project.php" >
                                                <div class="position-relative h-100 product-container">
                                                    ...
                                                    <img class="position-absolute img-fluid w-100 h-100" src="{{ $value['first_media']['link']??asset('assets/img/main-logo.png')}}"
                                                        style="object-fit: cover;" alt="">
                                                        <div class="product-overlay">
                                                            <h5 class="product-name"><?php echo $value['title']?></h5>
                                                            <div class="project-property-name">
                                                                <span><?php echo $value['address']??'N/A'?></span> <span class="project-property"> | <?php echo $value['description']??'N/A'?><span>
                                                            </div>
                                                            <a href="{{url('project/'.$value['route_name'])}}" class="view-product-btn">View Project</a>
                                                        </div>
                                                </div>
                                            </a>
                                        </div>
