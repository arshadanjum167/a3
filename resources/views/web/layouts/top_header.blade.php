<nav  id="mainNavbar" class="navbar navbar-expand-lg bg-white fixed-top navbar-light sticky-top1 py-lg-0 px-lg-5 wow fadeIn bg-color-blue" data-wow-delay="0.1s">
    <a href="{{route('web_home')}}" class="navbar-brand ms-4 ms-lg-0">
        <h1 class="text-primary m-0"><img class="me-3 w-100p h-75p" src="{{ asset('assets/img/logo.png') }}" alt="Icon"></h1>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto p-4 p-lg-0">
            ...
            <a href="{{route('show_casestudy')}}" class="nav-item nav-link">Case-study</a>
