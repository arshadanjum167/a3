   ...
   <?php include_once('spinner.php'); ?>
    ...
    <div class="container-fluid p-0 pb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="owl-carousel header-carousel position-relative">
            <div class="owl-carousel-item position-relative" data-dot="<img src='img/project-5.jpg'>">
                        ...
                        <div class="tab-pane fade show active" id="tab-pane-1">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            ...
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-5.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
                                ...
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-6.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            ...
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-7.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
                                ...
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-8.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            ...
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-9.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
                                ...
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-10.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            ...
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-11.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
                                ...
                                <div class="col-md-6" style="min-height: 350px;">
                                    <a href="project.php" >
                                        <div class="position-relative h-100 product-container">
                                            <img class="position-absolute img-fluid w-100 h-100" src="img/project-13.jpg"
                                                style="object-fit: cover;" alt="">
                                                <div class="product-overlay">
